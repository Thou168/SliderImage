package com.example.library.sliderimage;
...
public abstract class RecyclerViewSliderBase<L extends RecyclerView.LayoutManager, A extends RecyclerView.Adapter> extends FrameLayout {
    ...
    public RecyclerViewSliderBase(Context context) {
        this(context, null);
    }

    public RecyclerViewSliderBase(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyclerViewSliderBase(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    protected void initView(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RecyclerViewSliderBase);
        showIndicator = a.getBoolean(R.styleable.RecyclerViewSliderBase_showIndicator, true);
        autoPlayDuration = a.getInt(R.styleable.RecyclerViewSliderBase_interval, 4000);
        isAutoPlaying = a.getBoolean(R.styleable.RecyclerViewSliderBase_autoPlaying, true);
        mSelectedDrawable = a.getDrawable(R.styleable.RecyclerViewSliderBase_indicatorSelectedSrc);
        mUnselectedDrawable = a.getDrawable(R.styleable.RecyclerViewSliderBase_indicatorUnselectedSrc);
        ...
        indicatorMargin = a.getDimensionPixelSize(R.styleable.RecyclerViewSliderBase_indicatorSpace, dp2px(4));
        int marginLeft = a.getDimensionPixelSize(R.styleable.RecyclerViewSliderBase_indicatorMarginLeft, dp2px(16));
        int marginRight = a.getDimensionPixelSize(R.styleable.RecyclerViewSliderBase_indicatorMarginRight, dp2px(0));
        int marginBottom = a.getDimensionPixelSize(R.styleable.RecyclerViewSliderBase_indicatorMarginBottom, dp2px(11));
        int g = a.getInt(R.styleable.RecyclerViewSliderBase_indicatorGravity, 0);
        int gravity;
        if (g == 0) {
        ...
        int o = a.getInt(R.styleable.RecyclerViewSliderBase_orientation, 0);
        int orientation = 0;
        if (o == 0) {
