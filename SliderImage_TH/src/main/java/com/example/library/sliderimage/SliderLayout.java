...
import com.example.library.sliderimage.layoutmanager.CenterSnapHelper;
import com.example.library.sliderimage.layoutmanager.SliderLayoutManager;
...
public class SliderLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SliderLayout);
        showIndicator = a.getBoolean(R.styleable.SliderLayout_showIndicator, true);
        autoPlayDuration = a.getInt(R.styleable.SliderLayout_interval, 4000);
        isAutoPlaying = a.getBoolean(R.styleable.SliderLayout_autoPlaying, true);
        itemSpace = a.getInt(R.styleable.SliderLayout_itemSpace, 20);
        centerScale = a.getFloat(R.styleable.SliderLayout_centerScale, 1.2f);
        moveSpeed = a.getFloat(R.styleable.SliderLayout_moveSpeed, 1.0f);
        ...
        int gravity = GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        int o = a.getInt(R.styleable.SliderLayout_orientation, 0);
        int orientation = 0;
        if (o == 0) {
        ...
        mLayoutManager = new SliderLayoutManager(getContext(), orientation);
